...
public class WitherStormHunchback1_2Model<T extends WitherStormEntity> extends AbstractWitherStormModel<T> {
   ...
   public static LayerDefinition createLayerDefinition(CubeDeformation def) {
      ...
      WSHunchback1_2.createBodyModel(mesh.getRoot(), 1.0F);
