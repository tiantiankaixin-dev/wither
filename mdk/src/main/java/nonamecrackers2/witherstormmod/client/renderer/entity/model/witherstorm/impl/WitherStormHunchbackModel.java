...
public class WitherStormHunchbackModel<T extends WitherStormEntity> extends AbstractWitherStormModel<T> {
   ...
   public static LayerDefinition createLayerDefinition(CubeDeformation def) {
      ...
      HunchbackBodyModel.createBodyModel(mesh.getRoot(), 1.0F);
