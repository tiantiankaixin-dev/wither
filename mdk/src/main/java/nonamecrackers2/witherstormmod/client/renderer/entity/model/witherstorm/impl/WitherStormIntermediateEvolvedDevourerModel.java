...
public class WitherStormIntermediateEvolvedDevourerModel<T extends WitherStormEntity> extends ThreeHeadedWitherStormModel<T> {
   ...
   protected void configureTentacles(ModelPart root) {
      ...
      this.tentacles[0].tentacle.setPos(-20.0F, -25.0F, 5.0F);
      ...
      this.tentacles[1].tentacle.setPos(20.0F, -27.5F, 7.0F);
      ...
      this.tentacles[2].tentacle.setPos(-10.0F, -30.0F, -10.0F);
      ...
      this.tentacles[3].tentacle.setPos(8.0F, -34.0F, -6.0F);
      ...
      this.tentacles[4].tentacle.setPos(-8.0F, -25.0F, 16.0F);
      ...
      this.tentacles[5].tentacle.setPos(10.0F, -23.0F, 19.0F);
      ...
      this.tentacles[6].tentacle.setPos(-2.0F, 0.0F, 0.0F);
      ...
      this.tentacles[7] = new TentacleModel(root.getChild("tentacleLarge0"), 4.5F);
      ...
      this.tentacles[8] = new TentacleModel(root.getChild("tentacleLarge1"), 4.5F);
