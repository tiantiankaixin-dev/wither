...
public class WitherStormModAttributes {
   public static final DeferredRegister<Attribute> ATTRIBUTES = DeferredRegister.create(BuiltInRegistries.ATTRIBUTE, "witherstormmod");
   public static final DeferredHolder<Attribute, Attribute> TARGET_STATIONARY_FLYING_SPEED = ATTRIBUTES.register(
   ...
   public static final DeferredHolder<Attribute, Attribute> SLOW_FLYING_SPEED = ATTRIBUTES.register(
      "slow_flying_speed", () -> new RangedAttribute("attribute.witherstormmod.name.slow_flying_speed", 0.02, 0.01, 1.0).setSyncable(true)
   );
   public static final DeferredHolder<Attribute, Attribute> EVOLUTION_SPEED = ATTRIBUTES.register(
      "evolution_speed", () -> new RangedAttribute("attribute.witherstormmod.name.evolution_speed", 1.0, 0.0, 1024.0).setSyncable(true)
   );
   public static final DeferredHolder<Attribute, Attribute> HUNCHBACK_FOLLOW_RANGE = ATTRIBUTES.register(
