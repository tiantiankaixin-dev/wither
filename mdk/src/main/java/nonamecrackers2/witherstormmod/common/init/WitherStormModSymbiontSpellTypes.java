...
public class WitherStormModSymbiontSpellTypes {
   ...
   public static final DeferredHolder<SpellType, SpellType> EMPTY = SPELL_TYPES.register("empty", () -> new SpellType(EmptySpell::new, 0, Optional.empty(), false));
   public static final DeferredHolder<SpellType, SpellType> EVOKER_FANGS = SPELL_TYPES.register(
      "evoker_fangs", () -> new SpellType(EvokerFangsSpell::new, 20, Optional.empty())
   );
   public static final DeferredHolder<SpellType, SpellType> SHULKER_BULLETS = SPELL_TYPES.register(
      "shulker_bullets", () -> new SpellType(ShulkerBulletsSpell::new, 80, Optional.empty())
   );
   public static final DeferredHolder<SpellType, SpellType> ARROWS = SPELL_TYPES.register("arrows", () -> new SpellType(ArrowsSpell::new, 120, Optional.empty()));
   public static final DeferredHolder<SpellType, SpellType> SMASH = SPELL_TYPES.register("smash", () -> new SpellType(SmashSpell::new, 40, Optional.empty()));
   public static final DeferredHolder<SpellType, SpellType> FIRE_BALLS = SPELL_TYPES.register("fire_balls", () -> new SpellType((s, t) -> {
   ...
   public static final DeferredHolder<SpellType, SpellType> WITHER_SKULLS = SPELL_TYPES.register(
      "wither_skulls", () -> new SpellType(WitherSkullsSpell::new, 220, Optional.empty())
   );
   public static final DeferredHolder<SpellType, SpellType> PULL = SPELL_TYPES.register(
      "pull", () -> new SpellType(PullSpell::new, 240, Optional.of(WitherStormModSoundEvents.WITHERED_SYMBIONT_PULL), false)
   );
   public static final DeferredHolder<SpellType, SpellType> THROWING = SPELL_TYPES.register("throwing", () -> new SpellType(ThrowingSpell::new, 240, Optional.empty()));
   public static final DeferredHolder<SpellType, SpellType> BOMBING = SPELL_TYPES.register("bombing", () -> new SpellType(BombingSpell::new, 60, Optional.empty()));
   public static final DeferredHolder<SpellType, SpellType> PULSE = SPELL_TYPES.register(
