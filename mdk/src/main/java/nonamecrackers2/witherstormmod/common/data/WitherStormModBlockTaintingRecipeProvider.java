...
public class WitherStormModBlockTaintingRecipeProvider extends BlockTaintingRecipeProvider {
   ...
   protected void addRecipes() {
      ...
      this.addAndCopyAllProperties(net.neoforged.neoforge.common.Tags.Blocks.COBBLESTONE, (Block)WitherStormModBlocks.TAINTED_COBBLESTONE.get());
      ...
      this.addAndCopyAllProperties(net.neoforged.neoforge.common.Tags.Blocks.SAND, (Block)WitherStormModBlocks.TAINTED_SAND.get());
      this.addAndCopyAllProperties(net.neoforged.neoforge.common.Tags.Blocks.GLASS, (Block)WitherStormModBlocks.TAINTED_GLASS.get());
      this.addAndCopyAllProperties(net.neoforged.neoforge.common.Tags.Blocks.GLASS_PANES, (Block)WitherStormModBlocks.TAINTED_GLASS_PANE.get());
      ...
      this.addAndCopyAllProperties(net.neoforged.neoforge.common.Tags.Blocks.SANDSTONE, (Block)WitherStormModBlocks.TAINTED_SANDSTONE.get());
