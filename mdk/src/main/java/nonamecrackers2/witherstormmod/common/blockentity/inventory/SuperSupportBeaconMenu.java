...
public class SuperSupportBeaconMenu extends AbstractSuperBeaconMenu {
   public SuperSupportBeaconMenu(int id, Container container) {
      super((MenuType<? extends AbstractSuperBeaconMenu>)WitherStormModMenuTypes.SUPER_SUPPORT_BEACON.get(), id, container);
   }
   ...
   public boolean stillValid(Player player) {
      return stillValid(this.access, player, (Block)WitherStormModBlocks.SUPER_SUPPORT_BEACON.get());
   }
}
