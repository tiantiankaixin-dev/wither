...
public abstract class AbstractSuperBeaconRenderer<T extends AbstractSuperBeaconBlockEntity> implements BlockEntityRenderer<T> {
   ...
   public static void renderBeam(
      ...
      if (active) {
         ...
         BeaconRenderer.renderBeaconBeam(
            ...
            0,
            beamHeight,
            FastColor.ARGB32.color(255, color[0], color[1], color[2]),
            beamThickness,
            outerThickness
         );
         stack.popPose();
   ...
   public static void renderConnectBeam(
      ...
      consumer.addVertex(pose, -pulse, 0.0F, 0.0F)
         .setColor(r, g, b, a)
         .setUv(0.0F, 0.0F)
...
;
      consumer.addVertex(pose, pulse, 0.0F, 0.0F)
         ...
         .setNormal(0.0F, 1.0F, 0.0F)
;
      consumer.addVertex(pose, pulse, (float)start.distanceTo(end), 0.0F)
         .setColor(r, g, b, a)
         .setUv(1.0F, 1.0F)
         .setOverlay(OverlayTexture.NO_OVERLAY)
         .setLight(15728880)
...
;
      consumer.addVertex(pose, -pulse, (float)start.distanceTo(end), 0.0F)
         ...
         .setNormal(0.0F, 1.0F, 0.0F)
;
      consumer.addVertex(pose, 0.0F, 0.0F, -pulse)
         .setColor(r, g, b, a)
         .setUv(0.0F, 0.0F)
         .setOverlay(OverlayTexture.NO_OVERLAY)
         .setLight(15728880)
...
;
      consumer.addVertex(pose, 0.0F, 0.0F, pulse)
         ...
         .setNormal(0.0F, 1.0F, 0.0F)
;
      consumer.addVertex(pose, 0.0F, (float)start.distanceTo(end), pulse)
         .setColor(r, g, b, a)
         .setUv(1.0F, 1.0F)
         .setOverlay(OverlayTexture.NO_OVERLAY)
         .setLight(15728880)
...
;
   ...
   protected static void drawBox(
      ...
      Matrix4f pose = stack.last().pose();
      consumer.addVertex(pose, -scale, -scale, -scale)
