...
public class WitherStormModPaintingTypes {
   ...
   public static final RegistryObject<PaintingVariant> AMULET = PAINTING_MOTIVES.register(
      "amulet", () -> new PaintingVariant(16, 32, ResourceLocation.fromNamespaceAndPath("witherstormmod", "amulet"))
   );
