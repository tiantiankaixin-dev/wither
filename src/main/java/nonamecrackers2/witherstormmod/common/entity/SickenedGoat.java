...
public class SickenedGoat extends Goat implements WitherSickened, Enemy {
   private static final EntityDataAccessor<Boolean> CONVERTING = SynchedEntityData.defineId(SickenedGoat.class, EntityDataSerializers.BOOLEAN);
   ...
   public Goat getBreedOffspring(ServerLevel level, AgeableMob mob) {
      return null;
   }
}
