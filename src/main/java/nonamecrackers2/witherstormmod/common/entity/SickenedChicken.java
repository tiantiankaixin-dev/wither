...
public class SickenedChicken extends Chicken implements WitherSickened, Enemy {
   private static final EntityDataAccessor<Boolean> CONVERTING = SynchedEntityData.defineId(SickenedChicken.class, EntityDataSerializers.BOOLEAN);
   ...
   public static Builder createAttributes() {
      return Monster.createMonsterAttributes().add(Attributes.MOVEMENT_SPEED, 0.25).add(Attributes.MAX_HEALTH, 16.0).add(Attributes.FOLLOW_RANGE, 24.0);
   }
