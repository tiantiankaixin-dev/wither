...
@Deprecated
public class WitherStormPlayDeadTrigger extends SimpleCriterionTrigger<WitherStormPlayDeadTrigger.Instance> {
   ...
   protected WitherStormPlayDeadTrigger.Instance createInstance(JsonObject object, ContextAwarePredicate player, DeserializationContext parser) {
      ContextAwarePredicate entity = EntityPredicate.fromJson(object, "entity", parser);
      return new WitherStormPlayDeadTrigger.Instance(this.id, player, entity);
   }
